-- mysql-setup.sql - Configuración inicial de base de datos Of Everything

-- Crear base de datos
CREATE DATABASE IF NOT EXISTS of_everything;
USE of_everything;
...
('iPhone 13 Pro', 'Smartphone en excelente estado, 256GB, color azul', 18000.00, 'electronics', 'https://images.unsplash.com/photo-1632661674596-618e45e56c53?ixlib=rb-4.0.3&w=400', 1),
('Sofá de 3 plazas', 'Sofá cómodo, color gris, poco uso, perfecto estado', 4500.00, 'home', 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&w=400', 1),
('Zapatos deportivos', 'Zapatos Nike talla 28, nuevos, originales', 1200.00, 'fashion', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-4.0.3&w=400', 1);
